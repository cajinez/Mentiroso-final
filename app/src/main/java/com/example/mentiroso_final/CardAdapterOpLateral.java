...
public class CardAdapterOpLateral extends RecyclerView.Adapter<CardAdapterOpLateral.ViewHolder>  {
    private GameActivity juegoActividad = new GameActivity();
    private ArrayList<Card> cardList;
    private Context context;
    public CardAdapterOpLateral(){

    }
    public CardAdapterOpLateral(ArrayList<Card> cardList, Context context, GameActivity activity) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_card_lateral, parent, false);
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(@NonNull View itemView) {
            super(itemView);
            imageCard = itemView.findViewById(R.id.image_card_lateral);
        }
    }
